const commentsList = [{
  id: 1,
  userName: 'John Doe',
  commentText: "Welcome! You can reply to the comments. But you can't delete the initial comment.",
  replies: [{
    id: 2,
    userName: 'User 1',
    commentText: 'You can reply nested or delete any comment. You can edit the existing comments.',
    replies: [{
      id: 3,
      userName: 'User 2',
      commentText: 'Refresh & see the changes persist. You can reset the comments to the initial state',
    }]
  }]
}
];
const initialData = JSON.parse(JSON.stringify(commentsList));
